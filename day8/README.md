...
3. 因為網路的資料太過片面，對初學者來說太不友善，學習上缺乏系統，這樣會導致學習過程中如果遇到問題很容易半途而廢
所以我認為與其讓人在網路上找資料學到一些錯誤的觀念，還不如我一邊教學一邊介紹爬蟲世界該有的道德觀
...
3. 查詢npm套件
    * 我們已經透過網路資源搜索到很多看起來能使用的套件，但能否應用在我們的實際需求就需要近一步透過實際測試來確認，以下是我當時找到的資源並附上時測後的分析:
        ...
        2. selenium-webdriver
            ...
            * 工具執行時會開啟一個網頁，然後模擬人類真實的操作每個步驟，所以效率很差，但學習非常容易且直覺，所以這是本專案最後選擇的工具
